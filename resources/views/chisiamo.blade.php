<!doctype html>
    <html lang="en">
        ...
        <body>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center align-items-center text-center bg-dark">
                        ...
                        <div class="card-header">{{$taff["id"] }}</div>
                         <img src="" class="card-img-top" alt="..."> 
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{route('dettagli-staff',['id' => $taff['id']]) }}" class="btn btn-primary">scopri di piú</a>
                            </div>
                        </div>
                    </div>
                @endforeach
